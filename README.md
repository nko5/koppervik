...
~~~sh
# getting the code
git clone git@github.com:nko5/koppervik.git && cd ./koppervik/
...
# deploying to Modulus (to http://koppervik.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/koppervik" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
